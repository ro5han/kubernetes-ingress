...
We strongly recommend inspecting the RBAC configuration in the deployment file or Helm chart (see [here](https://github.com/nginxinc/kubernetes-ingress/blob/main/charts/nginx-ingress/templates/rbac.yaml)
